...
let variants = cva(
  'inline-flex items-center justify-center whitespace-nowrap text-base transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
...
let Button = forwardRef<HTMLElement, Props>((props, ref) => {
  let { as = 'button', variant, shape = 'rounded', weight, text, link, openInNewTab, className, ...rest } =
    props;
...
export let buttonInputs: InspectorGroup['inputs'] = [
  ...
  },
  {
    ...
    configs: {
      options: [
        { label: 'Medium', value: 'font-medium text-orange-600' },
        { label: 'Semibold', value: 'font-semibold text-orange-600' },
        { label: 'Bold', value: 'font-bold text-orange-600' },
      ],
    },
