...
let FeaturedCollections = forwardRef<HTMLElement, FeaturedCollectionsProps>(
  (props, ref) => {
    let { loaderData, heading, subheading, collectionsCount, ...rest } = props;
    return (
  ...
  inspector: [
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          name: 'subheading',
          label: 'Sub-heading',
          defaultValue: 'Discover our Featured Collections',
          placeholder: 'Discover Our Featured Collections',
        },
        {
          type: 'range',
